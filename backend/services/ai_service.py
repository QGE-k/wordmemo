...
9. 提供2个简短例句，每句英文不超过12个单词，难度控制在江西专升本/大学英语三级水平，用词简单、贴近校园和学习生活。例句中的英文必须语法正确、表达自然。
   【例句翻译要求】中文翻译必须准确、通顺、符合中文表达习惯，不能逐词机翻，要简短对应。
...
【核心要求】
1. 生成2个简短例句，每句英文不超过12个单词，适合背单词快速记忆
   - 两个例句的句式、场景、主语尽量不同（一个陈述、一个问句；或不同主语）
   - 两个例句必须展示该单词最常见的用法和搭配

2. 【专升本难度】例句难度严格控制在江西专升本/大学英语三级水平：
   - 用词简单，避免生僻词和复杂从句
   - 内容贴近大学生活、学习、校园、日常场景
   - 句子简短、直白、易读，一句话讲清一个意思

3. 例句必须语法正确、表达自然，像真实英语对话或短文中的句子
4. 中文翻译必须准确、通顺、符合中文表达习惯，不能逐词机翻，要简短对应
5. 如果是短语（如look up to），例句必须正确使用该短语的语法形式

【话题方向】优先选择专升本常见语境：
学习与教育、校园生活、大学生活、职业规划、日常交流、健康生活、科技生活
...
{"examples": [{"en": "英文例句", "zh": "中文翻译"}, {"en": "英文例句", "zh": "中文翻译"}]}"""
        ...
        user_prompt = f'请为单词或短语 "{word}" 生成2个简短、专升本难度的例句。{meaning_hint}'
